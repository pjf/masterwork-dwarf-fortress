...
[INTERACTION:SPELL_ARCANE_MYSTIC_BANISH]
        ...
        [I_EFFECT:ADD_SYNDROME]
                ...
                [SYNDROME]
                        ...
                        [SYN_CLASS:NONE]
                        [SYN_CLASS:NONE]
                        [SYN_CLASS:ARCANE4,ARCANE3]
                        [SYN_CLASS:ELEMENTAL;ARCANE,GREATER_ELEMENTAL;ARCANE]
...
local function effect(etype,unit,radius,time,target,aclass,acreature,asyndrome,atoken,iclass,icreature,isyndrome,itoken)
        local i
...
effect(etype,unit,radius,time,target,aclass,acreature,asyndrome,atoken,iclass,icreature,isyndrome,itoken)