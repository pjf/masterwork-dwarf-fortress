...
if args[2] == 'invaders-deep' then
	creatureSet = {['HUMAN'] = true, ['KOBOLD'] = true, ['KOBOLD_CAMP'] = true, ['ORC_TAIGA'] = true, ['DWARF_EVIL'] = true, ['HUMAN_EVIL'] = true, ['DROW_EVIL'] = true, ['ELF_EVIL'] = true, ['DROW'] = true, ['GNOME_CIV'] = true, ['ELF'] = true, ['DWARF'] = true, ['GOBLIN'] = true, ['ANT_MAN'] = true, ['GREMLIN'] = true, ['TROGLODYTE'] = true, ['ORC'] = true}
