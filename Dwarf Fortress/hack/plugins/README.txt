...
Version: 0.3
Thread: http://www.bay12forums.com/smf/index.php?topic=125164.0
Allows you to tag selected stockpiles, so that whenever caravans arrives, items in those stockpiles will automatically be marked for hauling to the trade depot. Checking will be done every half a day and you can also do a one off marking of all items in a specific stockpile. Also adds (un)mark all options to trade screen.
...
Version: 0.3
Thread: http://www.bay12forums.com/smf/index.php?topic=130000.0
