            ...
            if (nIndex == this.SelectedIndex)
            {
                ...
                switch (_alignments)
                {
                    case TabAlignments.Top:
                        ...
                        if (((TabPageEx)this.SelectedTab).IsClosable)
                        {
                        ...
                        using (GraphicsPath gp = new GraphicsPath())
                        {
                            ...
                            if (((TabPageEx)this.SelectedTab).IsClosable && conditionButtonStateArray[0] == ButtonState.Normal)
                            {
                            ...
                            else if(((TabPageEx)this.SelectedTab).IsClosable)
